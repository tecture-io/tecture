...
| --- | --- | --- | --- |
| [skills.sh](https://skills.sh) (Vercel) | ✅ live | `npx skills add tecture-io/architecture-docs` | auto-indexed from the mirror repo |
...
2. **Sync the mirror** — copy the updated skill tree into `tecture-io/architecture-docs`, commit, push. skills.sh and `gh skill` auto-pick up the latest commit; no further action needed for those two channels.
